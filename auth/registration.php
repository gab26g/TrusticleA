          ...
          <div class="logo">
            <div class="logo-placeholder">
              <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M30 20C30 22.7614 27.7614 25 25 25C22.2386 25 20 22.7614 20 20C20 17.2386 22.2386 15 25 15C27.7614 15 30 17.2386 30 20Z" fill="#2A9D8F"/>
                <path d="M25 25C19.4772 25 15 29.4772 15 35H35C35 29.4772 30.5228 25 25 25Z" fill="#2A9D8F"/>
              </svg>
            </div>
            <h2 class="logo-text">Tru<span class="slash">/</span>ticle</h2>
          </div>
